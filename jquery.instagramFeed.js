    ...
    function render(options, data){
        ...
        if(options.display_gallery){
            ...
            for (var i = 0; i < max; i++) {
                ...
                //TODO: Test captions
                html += '<a href="' + itemData.image + '"' + (options.display_captions ? ' data-caption="' + itemData.caption + '"' : '') + ' class="instagram-' + itemData.type + '" rel="noopener" target="_blank"' + styles.gallery_image_link + '>';
